...
@Component({
    selector: "app-favoritimages",
    templateUrl: "./favoritimages.component.html",
    styleUrls: ["./favoritimages.component.css"],
})
export class FavoritimagesComponent implements OnInit {
    list: any = [];
    constructor(private http: HttpClient) {}

    ngOnInit() {
        this.http.get(`http://localhost:4000/image/favorit`).subscribe(
            (res) => {
                console.log(res);
